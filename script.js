...
document.getElementById('btn_calc').addEventListener('click', function () {
    ...
    if (operation === 'squa'){
        const result =  Math.sqrt(parseFloat(inputWindow.value.substr(1)));
        operation = null;
        lastOperand = 0;
        inputWindow.value = result;
    }
...
document.getElementById('btn_squa').addEventListener('click', function () {
    inputWindow.value = '';
...
document.getElementById('btn_over').addEventListener('click', function () {
    lastOperand = parseFloat(inputWindow.value);
    operation = 'over';
    inputWindow.value = '';
})
...
document.getElementById('btn_unar').addEventListener('click', function () {
    const unar = (-inputWindow.value);
    inputWindow.value = unar;
})
